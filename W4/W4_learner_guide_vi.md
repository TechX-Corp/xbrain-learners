...
- Bản đồ AI/ML: supervised / unsupervised / reinforcement learning, các kiến trúc deep learning (CNN, RNN, Transformer, GAN), và con đường từ classical ML đến GenAI
...
| **RDS/Aurora hoặc SQLite** | Chứa dữ liệu có cấu trúc (costs, incidents, SLA targets) cho L3 tool queries |
...
### L1 — Simple RAG (mục tiêu: xong trước 12:00)
...
### L2 — Advanced RAG (mục tiêu: xong trước 15:00)
...
### L3 — Tool-Augmented RAG (mục tiêu: tool call đầu tiên trước 17:00)
